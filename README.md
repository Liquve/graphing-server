...
Сервер написан на C++/Qt, хранит пользователей в стандартном PostgreSQL и ходит во внешний
...
запущен отдельно. Запросы на восстановление пароля не удаляются из базы:
